...
exports.RetrieveGuestDataExtensions = void 0;
const CdpClient_1 = require("../../client/CdpClient");
const zod_1 = require("zod");
class RetrieveGuestDataExtensions {
    async AddTool(server) {
        server.tool(
        //name
        "RetrieveGuestDataExtensions", 
        //description
        "Retrieves all guest data extensions for a guest in Sitecore CDP using the Guest API.", 
        //paramsSchema
        {
        ...
        //annotations
        {
            title: "Retrieves all guest data extensions for a guest in Sitecore CDP", // Human-readable title for the tool
        ...
        //callback
        async ({ guestRef, offset, limit, expand }) => {
            const queryParams = {};
            ...
            const response = await new CdpClient_1.CdpClient().MakeRequest(`guests/${guestRef}/extensions?${query}`, 'GET', null);
...
exports.RetrieveGuestDataExtensions = RetrieveGuestDataExtensions;
