...
exports.CreateGuestDataExtension = void 0;
const CdpClient_1 = require("../../client/CdpClient");
const zod_1 = require("zod");
class CreateGuestDataExtension {
    async AddTool(server) {
        ...
        //annotations
        {
            title: "Creates a guest data extension in Sitecore CDP", // Human-readable title for the tool
        ...
        async ({ guestRef, dataExtensionName, extensions }) => {
            ...
            const response = await new CdpClient_1.CdpClient().MakeRequest(`guests/${guestRef}/extensions`, 'POST', extensionObj);
...
exports.CreateGuestDataExtension = CreateGuestDataExtension;
