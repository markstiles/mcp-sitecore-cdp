...
// valid type values: "array", "boolean", "integer", "null", "number", "object", "string"
exports.GuestTools = [
    {
        name: "CreateGuest",
        ...
        inputSchema: {
            ...
            properties: {
                ...
                passportExpiry: { type: "string", description: "The expiry date of the guest's passport. Example: 2025-01-01T00:00:00.000Z" },
                passportNumber: { type: "string", description: "The passport number of the guest." },
                phoneNumbers: { type: "array", items: { type: "string" }, description: "The phone numbers of the guest. Example: +353161123345, +353161123346" },
                postCode: { type: "string", description: "The guest's zipcode." },
                state: { type: "string", description: "The state (address) of the guest." },
                street: { type: "string", items: { type: "string" }, description: "The street address of the guest." },
